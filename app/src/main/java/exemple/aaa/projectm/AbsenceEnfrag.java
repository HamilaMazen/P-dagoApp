 ...
 */
public class AbsenceEnfrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v=inflater.inflate(R.layout.fragment_absence_enfrag, container, false);
        mStorageReference = FirebaseStorage.getInstance().getReference();
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Costants.DATABASE_PATH_UPLODS_ABEB);

        //getting the views
        textViewStatus = (TextView) v.findViewById(R.id.textViewStatusabs);
        editTextFilename = (EditText) v.findViewById(R.id.editTextFileNameabs);
        progressBar = (ProgressBar) v.findViewById(R.id.progressbarabs);

        //attaching listeners to views
        btnuplod=(Button)v.findViewById(R.id.buttonUploadFileabs);
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child(Costants.STOREGE_PATH_UPLODS_ABEB + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
